// Step 10/10 of Run THEAAAAA-408: log the published record into the production
// dedup store `public.facebook_publications`.
//
// Fail-closed gate was already satisfied OUT of this script (Step 9 THEAAAAA-419
...
const record = JSON.parse(await readFile(join(here, "..", ".run-408-record.json"), "utf8"));
