// Step 10/10 of Run THEAAAAA-527: log the published record into the production
// dedup store `public.facebook_publications`.
//
// Fail-closed gate was already satisfied OUT of this script (Step 9 THEAAAAA-538
...
const record = JSON.parse(await readFile(join(here, "..", ".run-527-record.json"), "utf8"));
